...
###### 3228为一款三网口工业用LTE/NR网关, 此网关含有
 - **3G/4G/5G全网通频段接入**(*5G四天线*), **三个千兆以太网口(RJ45)**, **双串口**, *串口1为RS232, 串口2为RS485(可定制为RS232)*
...
###### 多种方式接入互联网
 ...
 - **5.8G无线接入互联网**,  **5.8G无线中继桥接**, **多SSID优先连接**
 - **混合(多WAN)上网---3G/4G/5G与有线WAN口接入同时工作**, 冷备份, 热备份及负载均衡带宽叠加
 - **混合(多WAN)上网---3G/4G/5G与2.4G无线接入同时工作**, 冷备份, 热备份及负载均衡带宽叠加, 实现在无人机或车载上进站连本地无线网络出站使用LTE/NR上网的功能
 - **混合(多WAN)上网---3G/4G/5G与5.8G无线接入同时工作**, 冷备份, 热备份及负载均衡带宽叠加, 实现在无人机或车载上进站连本地无线网络出站使用LTE/NR上网的功能
...
###### 提供多种接口供设备连接到互联网
 - **以太网口(802.3u/802.3z)**
 - **2.4G无线(802.11bgn)**
 - **5.8G无线(802.11a/802.11an/802.11ac)**
 - **串口(RS485/RS232)**
 - **IO口(3.3V输入输出)或I2C接口**
...
## 网关实物图
![avatar](./正面图.JPG) ![avatar](./网口侧.JPG) ![avatar](./接口侧.JPG) ![avatar](./侧面图.JPG)
...
| **WAN口** | RJ45 WAN接口(100/1000Mbps自适应), 网关模式及混合模式为**WAN接口**, 其它模式下为**LAN接口**, 自带LINK指定灯  |
| **LAN1口** | RJ45 LAN接口(100/1000Mbps自适应), 自带LINK指定灯  |
| **LAN2口** | RJ45 LAN接口(100/1000Mbps自适应), 自带LINK指定灯  |
...
| **WIFI天线接口(2个)** | WIFI2.4G/5.8双频 SMA天线接口*2(外螺纹+孔)  |
| **3G/4G/5G天线接口(5个)** | 3G/4G/5G SMA天线接口*2(外螺纹+孔) |
...
| **无线(WIFI)功能**| 2.4G无线热点<br>2.4G无线网卡<br>5.8G无线热点<br>5.8G无线网卡<br>无线黑白名单<br>发射功率调整<br>Portal功能：自定义广告界面, *WIFIdog广告推送(需定制)*，*Coova Chilli广告推送(需定制)* |
...
###### 2X2车载供电口: **分别标有两个-及两个+, 代表2负2正的管脚, 请按此标注给网关供电, 支持输入7V至48V直流电**
- -为供电负极
- +为供电正极
