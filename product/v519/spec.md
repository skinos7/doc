...
###### V519为一款小巧的双网口工业用LTE路由器, 此路由器含有
 - **2G/3G/4G全网通频段接入**(*4G双天线*), **双百兆以太网口(RJ45)**, **单串口**(*默认为RS485, 可定制为RS232/TTL*)
 - **工业用大SIM卡槽**
 - **无线2.4G双天线**(*300Mbit/s*)
 - **支持DC头供电或4PIN头供电**, 可通过DC头供电, 也可通过4PIN头对设备供电
 - **可选GPS功能**
 - **短信功能**, 支持中文短信及短信管理设备
...
###### 为支持工业级应用环境带有
 - **宽电压供电及4PIN头供电支持**, 支持7到48V之间的电压供电
...
![avatar](./正面接口图.png)  ![avatar](./前面接口图.png)  ![avatar](./后面接口图.png) 
