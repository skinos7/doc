...
| **虚拟专用网**| 支持L2TP客户端(*支持隧道密码*)<br>PPTP客户端(*支持MPPE*)<br>GRE隧道<br>OpenVPN客户端(*支持预共享密钥,证书*)<br>IPSEC(*支持预共享密钥,证书*)<br>ZeroTier<br>WireGuard<br>自组网<br>内网穿透 |
...
| **异地组网**<br>|网关间异地自由组网<br>多子网组网<br>使用SSLv3加密保证数据安全<br>多中心, 多终端, 终端与中心使用P2P通信(超低延迟不限流)<br>|
