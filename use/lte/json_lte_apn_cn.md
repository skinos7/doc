        ...
        "v":                      // 所有ifname@lte配置需要修改的属性值
        {
            "keeplive":
            {
                ...
                "icmp":
                {
                    "dest":
                    {
                        "test":"114.114.114.114",     // 修改ICMP 第一个检测地址
                        "test2":"8.8.8.8",            // 修改ICMP 第二个检测地址
                        "test3":"8.8.4.4"             // 修改ICMP 第三个检测地址
                    },
                    "timeout":"10",                   // 修改ICMP检测的 单次检测超时
                    "failed":"6",                     // 修改ICMP 检测次数
                    "interval":"2"                    // 修改ICMP 检测间隔
                }
            }
        }
    }
    ...
    "cmd1":
    {
        ...
        "v":                      // 所有ifname@lte配置需要修改的属性值
        {
            "keeplive":
            {
                ...
                "recv":
                {
                    "timeout":"20",     // 修改接收包计数的 统计时间段, 以秒为单位
                    "packets":"1",      // 修改接收包计数统计时间段内 要求包数, 以个为单位
                    "failed":"30"       // 修改接收包计数的 检测次数
                }
            }
        }
    }
    ...
    "cmd1":
    {
        ...
        "v":                      // 所有ifname@lte配置需要修改的属性值
        {
            "keeplive":
            {
                ...
                "dns":
                {
                    "timeout":"8",        // 修改DNS查询的 单次检测超时, 单位为秒
                    "failed":"6",         // 修改DNS 检测次数
                    "interval":"2"        // 修改DNS 检测间隔, 单位为秒
                }
            }
        }
    }
