...
- 默认用户名: admin, 默认密码: admin, 点击 **红框4** 即可登录 **网关管理平台管理员界面**   
...
- 输入刚添加的帐号: ashyelf, 及对应的密码, 点击 **红框4** 即可登录 **网关管理平台界面**   

#### 1. 查看在线网关列表

- 点击 **红框1** 的 **网关** 即可显示此用户下所有在线或是未在线的网关
...
- 点击 **网关总览界面** 中的 **红框3** **配置更改** 可直接打网关管理界面, 在此界面中可实时查看设备状态, 修改设备配置等
