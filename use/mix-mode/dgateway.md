...
- 点击 **红框3** **工作模式** 点选 **双WAN口网关** 后, 提示需要重启点击 **确定** 等待网关重启完成即可   

![avatar](./switch_dgateway_cn.jpg) 

在 **双WAN口网关** 下, 网关的WAN口为 **有线宽带(WAN)**, 用于连接 **上一级路由器**   
在 **双WAN口网关** 下, 网关的编号最大的LAN口会被转换成 **有线宽带(WAN)2** 用于连接 **上一级路由器**, 如网关上有LAN1, LAN2, LAN3, LAN4时, LAN4网口就会成为 **有线宽带(WAN)2**   
在 **双WAN口网关** 下, 网关其它的LAN口及无线则可用于接电脑或是其它设备上网用   

#### 2. 双WAN口网关中第一个WAN连接的设置

- 点击 **红框1** **网络** 菜单下的 **红框2** **有线宽带** 进入 **有线宽带设置界面**   

- 在 **有线宽带设置界面** 可以对第一个WAN口配置, 具体可参见 **[有线宽带联网设置](../readme_cn.md#有线宽带联网设置)**

![avatar](./dgateway_wan_setting_cn.jpg) 

#### 3. 双WAN口网关中第二个WAN连接的设置

- 点击 **红框1** **网络** 菜单下的 **红框2** **有线宽带2** 进入 **有线宽带2设置界面**   

- 在 **有线宽带2设置界面** 可以对第二个WAN口配置, 具体可参见 **[有线宽带联网设置](../readme_cn.md#有线宽带联网设置)**

![avatar](./dgateway_wan2_setting_cn.jpg) 
...
![avatar](./dgateway_con_setting_cn.jpg) 
